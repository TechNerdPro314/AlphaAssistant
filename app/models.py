...
from flask_login import UserMixin # Убедитесь, что этот импорт на месте

# UserMixin добавляет все необходимые Flask-Login свойства (is_authenticated, is_active и т.д.)
# Важно, чтобы он шел ПЕРЕД db.Model
class User(UserMixin, db.Model):
    ...
    business_profile = db.relationship('BusinessProfile', backref='user', uselist=False, lazy=True)
